...
function BreadcrumbCollapsed(props) {
  ...
  return (0, import_jsx_runtime10.jsx)("li", {
    children: (0, import_jsx_runtime10.jsx)(BreadcrumbCollapsedButton, _extends({
      focusRipple: true
    }, otherProps, {
      ownerState,
      children: (0, import_jsx_runtime10.jsx)(BreadcrumbCollapsedIcon, _extends({
...
var Breadcrumbs = React17.forwardRef(function Breadcrumbs2(inProps, ref) {
  ...
  const allItems = React17.Children.toArray(children2).filter((child) => {
    if (true) {
  ...
  return (0, import_jsx_runtime11.jsx)(BreadcrumbsRoot, _extends({
    ref,
    component,
...
//# sourceMappingURL=chunk-NGVZUY4T.js.map
